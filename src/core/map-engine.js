...
export const TEXTURE_KINDS = {
  trees:   { density: 20, scale: 11 },
  canopy:  { density: 22, scale: 10 },
  blades:  { density: 34, scale: 6 },
  scrub:   { density: 14, scale: 7 },
  furrows: { density: 0,  scale: 10 },
  waves:   { density: 0,  scale: 12 },
  dunes:   { density: 0,  scale: 14 },
  peaks:   { density: 14, scale: 14 },
  hills:   { density: 15, scale: 11 },
  cracks:  { density: 18, scale: 8 },
  marsh:   { density: 20, scale: 7 },
  speckle: { density: 40, scale: 3.5 },
  sparkle: { density: 28, scale: 3.5 },
  ember:   { density: 26, scale: 4 },
  thorns:  { density: 18, scale: 8 },
  rocks:   { density: 20, scale: 7 },
  stars:   { density: 30, scale: 2.4 },
  nebula:  { density: 10, scale: 22 },
  crystal: { density: 16, scale: 11 },
  bubbles: { density: 20, scale: 7 },
