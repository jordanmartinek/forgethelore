...
function renderLanguageDetailContent(lang) {
  return h('div', {},
    ...
    // Sections
    collapsible('Origin & History', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.origin || 'Not yet defined.')),
    collapsible('Speakers', true, h('div', { class: 'intel-card' }, h('div', { class: 'intel-card__value' }, lang.speakers || 'Unknown'))),
    collapsible('Phonology (Sound System)', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.phonology || 'Not yet defined.')),
    collapsible('Grammar & Syntax', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.grammar || 'Not yet defined.')),
    collapsible('Writing System', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.writingSystem || 'Not yet defined.')),
    collapsible('Naming Conventions', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.namingConventions || 'Not yet defined.')),
    collapsible('Vocabulary & Lexicon', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.vocabulary || 'Not yet defined.')),
    collapsible('Dialects & Variants', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.dialects || 'Not yet defined.')),
    collapsible('Idioms & Expressions', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.idioms || 'Not yet defined.')),
    collapsible('Taboos & Forbidden Words', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.taboos || 'Not yet defined.')),
    collapsible('Cultural Notes', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.culturalNotes || 'Not yet defined.')),
    collapsible('Relationship to Other Languages', true, h('p', { style: { fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', whiteSpace: 'pre-wrap' } }, lang.relationship || 'Not yet defined.')),
